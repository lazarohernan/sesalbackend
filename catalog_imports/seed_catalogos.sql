INSERT INTO cat_conceptos (codigo, descripcion) VALUES
...
INSERT INTO cat_concepto_ordenado (codigo, descripcion) VALUES
...
INSERT INTO cat_establecimientos (codigo, descripcion) VALUES
  ('19', 'ALONZO SUAZO'),
  ('27', 'FLOR DEL CAMPO'),
...
INSERT INTO cat_nivel_establecimiento (codigo, descripcion) VALUES
  ('1', 'Hospital Básico'),
  ('2', 'Hospital General'),
...
INSERT INTO cat_nivel_operativo (codigo, descripcion) VALUES
  ('001', 'Primer Nivel de Atención'),
  ('002', 'Segundo Nivel de Atención'),
  ('999', 'Otro')
ON DUPLICATE KEY UPDATE codigo = VALUES(codigo), descripcion = VALUES(descripcion);

INSERT INTO cat_formularios (codigo, descripcion) VALUES
  ('2', 'AT2-R (51 casillas)'),
  ('3', 'AT2-R-2012 (52 casillas)')
ON DUPLICATE KEY UPDATE codigo = VALUES(codigo), descripcion = VALUES(descripcion);

INSERT INTO cat_regiones (codigo, descripcion) VALUES
...
INSERT INTO cat_grupo_especial (nombre) VALUES
  ('< 5 Años'),
